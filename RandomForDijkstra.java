 ...
 */
public class RandomForDijkstra {
	 ...
	 * probability sets
	 */
	public RandomForDijkstra(Map<Integer, MeetingProbabilitySet> probs) {
		this.probs = probs;
	}
	...
	private class DistanceMap {
		 ...
		 * is found, returns {@link RandomForDijkstra#INFINITY} as the value.
