...
public class MaxPropRouter extends ActiveRouter {
	 ...
	 * The maximum amount of meeting probabilities to store.  可以存储的相遇概率的最大个数*/
	public static final String PROB_SET_MAX_SIZE_S = "probSetMaxSize";
    /** Default value for the meeting probability set maximum size ({@value}).默认值为相遇概率的最大值*/
	 ...
	 * 小于给定阈值的消息按其跳数进行排序，大于给定阈值的消息，按其传输成本进行排序。
	 */
